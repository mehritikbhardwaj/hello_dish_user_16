...
import 'package:hello_dish_app/screens/FavourateScreen/controller/fav_res_controller.dart';
...
class FavScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   final c= Get.put(FavResContropller());
   c.getFavRes();
    return Scaffold(
      appBar: AppBar(
        title: Text(
  ...
  restaurantsFilterRectangleCard(List<Datum> Restaurants) {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return restaurantFilterRectangleCard(Restaurants[index]);
        });
  }

  restaurantFilterRectangleCard(Datum restaurant) {
    return Padding(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                restaurant.restaurantId.restaurantAddress,
