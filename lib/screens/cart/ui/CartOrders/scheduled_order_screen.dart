...
class ScheduledOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<CartOrderController>(builder: (c) {
              ...
              child: Column(
                children: [
                  Align(
                    ...
                    child: Text("${c.readyToPlace.length} ORDER READY TO PLACE",
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: c.readyToPlace.length,
                        itemBuilder: (context, index) {
                          final list = c.readyToPlace[index];
                          return SizedBox(
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (c.allOrderList!.value.data[index].status < 5 &&
                              c.allOrderList!.value.data[index].cancelStatus ==
                                  0) {
...
orderedOrderCard(
    onPressed, isoder, quantity, item, price, imgUrl, orderPrice, createdAt) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
