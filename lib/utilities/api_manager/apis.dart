class APIs {
  ...
  static const cartOrders = "${base}customer/api/getOrder";
  static const categoryOrders = "${base}customer/api/getAllItemByCategory";
  static const favRestaurant = "${base}restaurant/api/getAllFav";
}
